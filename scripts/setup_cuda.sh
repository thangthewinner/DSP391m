...
echo "=========================================="
echo ""
echo "For better GPU performance, reconvert Whisper Large v3 with float16:"
echo ""
echo "  uv run ct2-transformers-converter \\"
echo "    --model openai/whisper-large-v3 \\"
echo "    --output_dir models/stt/whisper-large-v3-ct2-gpu \\"
echo "    --quantization float16"
echo ""
echo "Then update .env:"
echo "  STT_MODEL_PATH=models/stt/whisper-large-v3-ct2-gpu"
echo ""
